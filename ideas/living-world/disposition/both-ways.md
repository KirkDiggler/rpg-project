...
**Status:** RULED 2026-09-22 (Kirk). **SHIPPED** in rpg-toolkit: encounter **v0.100.0** (#1864), session **v0.102.0** (#1865); rpg-api dev 34b5d256 (#1027). Follow-up: rpg-api-protos#354 (`StanceChanged.cause`). Walk deferred to Kirk's World Builder day. Follows the hold-out design
