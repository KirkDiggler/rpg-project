...
## 1. Sides — who fights whom · *landed (encounter/hold-out 5e193205: one graph, formation asks it; 177 leaves fail when the table is forced never-hostile) · authoring landed (web/hold-out 97c0a298: Factions + Dispositions forms, predicate editor)*
...
## 2. Knowledge — what a member knows · *landed (encounter/hold-out 5e193205: known:fact with the learner as subject and audience; presence teaches the mind on the sweep and at the end of Hold/Loot)*
...
## 3. The flip — a fact changes a side · *landed (world/pair-settle e9da06e Settle; encounter/hold-out 5e193205 declares Raise + Settle per until, dissolves ByStance; 12 leaves fail without the Raise)*
