...
- [ ] The drawer is always visible by default, reads as a physical drawer opened from the left UI edge, and contains no verdict, damage total, modifier equation, or combat-log breakdown.
