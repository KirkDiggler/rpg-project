...
| 2026-08-24 | rpg-api#830 | consumers pin "protos v0.1.136" (the tag current when the plan was written) | the facing/offset fields generate under **v0.1.137** (the tag minted by protos#243's merge; v0.1.136 predates it) | tags mint at merge — a plan can name the PR, never the future tag |
