...
**Both are records, and they serve different purposes (Kirk, 2026-09-16).** The play record holds what happened *in* the run — the goblin's own memory of who threatened it, read by its mind and gone with the run. The world journal carries facts *out* of the run — what the camp, and later the town, come to know. A shenanigan's success writes to both from one seam: it lands a deed on the witnesses (the *individual* half — this goblin is cowed) and, if the author asked, teaches a fact to the same witnesses (the *faction* half — the camp learns its sergeant was cowed). Neither record is copied into the other; the two are not one store with a missing bridge. "Word spreads" (ideas/living-world/disposition, round 3) is about *who* learns a fact and *when*, and stays shelved until a verb pays for it.
