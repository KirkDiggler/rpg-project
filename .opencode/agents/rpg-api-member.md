---
description: OpenCode runtime adapter for rpg-api-member; canonical policy remains in the listed role documents.
mode: subagent
...
- `docs/teams/roles/rpg-api-member/prompt.md`
