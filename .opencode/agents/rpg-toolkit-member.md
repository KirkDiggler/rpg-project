---
description: OpenCode runtime adapter for rpg-toolkit-member; canonical policy remains in the listed role documents.
mode: subagent
...
- `docs/teams/roles/rpg-toolkit-member/prompt.md`
